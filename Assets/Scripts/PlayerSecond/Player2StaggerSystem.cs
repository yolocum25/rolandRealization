...
public class Player2StaggerSystem : MonoBehaviour
{
    [Header("Ref")]
    [SerializeField] private PlayerHealthSystem playerHealth;
    [SerializeField] private MonoBehaviour playerMovementScript; 
    [SerializeField] private PlayerSecondAttack playerAttackScript;
    ...
    private IEnumerator StaggerSequence()
    {
        ...
        if (anim != null) anim.Play("stagger", 0, 0f);
        ...
        pInput.SwitchCurrentActionMap("PlayerSecond");
